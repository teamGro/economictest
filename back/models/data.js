...
let links = {
  one: 'https://vc.ru/39208-rospotrebnadzor-oshtrafoval-produktovuyu-set-vkusvill-na-6-3-mln-rubley',
  two: 'https://vc.ru/39121-proizvoditel-vody-svyatoy-istochnik-vypustil-neozhidanno-ogneopasnuyu-butylku-v-forme-myacha',
  three: 'https://vc.ru/39509-wsj-osnovateli-whatsapp-lishilis-akciy-facebook-na-1-3-mlrd-posle-uhoda-iz-kompanii',
  four: {
    common: 'https://vc.ru/39346-gruzovaya-kompaniya-gazelkin-predlozhila-klientam-voditeley-slavyan-za-dopolnitelnuyu-platu',
  ...
  six: {
    first: 'https://vc.ru/39908-putin-osvobodil-germana-klimenko-ot-dolzhnosti-sovetnika-prezidenta-po-internetu',
    second: 'https://vc.ru/39908-putin-osvobodil-germana-klimenko-ot-dolzhnosti-sovetnika-prezidenta-po-internetu'
  },
  seven: 'https://vc.ru/39869-studiya-artemiya-lebedeva-predlozhila-startapam-ekspress-dizayn-lyubogo-predmeta-za-300-tysyach-rubley',
  eight: 'https://vc.ru/38748-eto-stydno-nanimat-lyudey-kotorymi-nuzhno-upravlyat'
};
...
module.exports = Object.freeze({
  ...
  '1': {
    ...
    answers: {
      ...
      commonText: `Проверка <a href=${links.one} target="_blank">обнаружила</a> просроченные продукты, но представители сети утверждают, что большая часть замечаний не коснулась их качества.`
    },
    btnTitle: 'Продолжить'
  },
  ...
  '2': {
    ...
    answers: {
      ...
      third: {
        ...
        text: 'Бутылка была довольно устойчивая, но благодаря своей форме призмы фокусировала свет так'
      },
      fourth: {
        answer: 'Её никто не покупал',
        text: 'Её покупали, но бутылка благодаря своей форме призмы фокусировала свет так'
      },
      right: 'Она оказалась огнеопасной',
      commonText: `, что он <a href=${links.two} target="_blank">воспламенял</a> окружающие предметы.`
    },
    btnTitle: 'Продолжить'
  },
  ...
  '3': {
    ...
    answers: {
      first: {
        ...
        text: 'Ян Кум и Брайан Эктон действительно могли получить акции на эту сумму, если бы проработали в Facebook до ноября 2018 года.'
      },
      second: {
        answer: 'Они не только лишились акций на $1,3 млрд и выплатили штрафы на $100 млн',
        text: 'Ян Кум и Брайан Эктон могли получить акции на $1,3 млрд, если бы проработали в Facebook до ноября 2018 года.'
      },
      third: {
      ...
      commonText: `Они ушли досрочно из-за <a href=${links.three} target="_blank">конфликта</a> с руководством.`
    },
    btnTitle: 'Продолжить'
  },
  ...
  '4': {
    ...
    answers: {
      ...
      second: {
        ...
        text: `Было пару раз, <a href=${links.four.personal} target="_blank">но не в июне</a>. На самом деле компания`
      },
      third: {
      ...
      commonText: `дала клиентам <a href=${links.four.common} target="_blank">возможность</a> выбрать водителя славянской внешности и российского гражданства. После скандала она переименовала услугу в «идеальный русский язык».`
    },
    btnTitle: 'Продолжить'
  },
  ...
  '5': {
    ...
    answers: {
      ...
      right: '20%',
      commonText: `НДС <a href=${links.five.first} target="_blank">собираются</a> повысить с 18% до 20%. Кстати, <a href=${links.five.second} target="_blank">вот чем</a> это грозит`
    },
    btnTitle: 'Продолжить'
  },
  ...
  '6': {
    ...
    answers: {
      ...
      commonText: `<a href=${links.six.second} target="_blank">планирует</a> заниматься собственными проектами в сфере цифровой медицины`
    },
    btnTitle: 'Продолжить'
  },
  ...
  '7': {
    ...
    answers: {
      ...
      commonText: `и заказчик точно так же <a href=${links.seven} target="_blank">обязан</a> принять первый предложенный вариант.`
    },
    btnTitle: 'Продолжить'
  },
  ...
  '8': {
    ...
    answers: {
      ...
      commonText: `Вопрос был с подвохом: все эти фразы прозвучали в <a href=${links.eight} target="_blank">интервью</a>.`
    },
    btnTitle: 'Продолжить'
  },
